...
namespace AIRSCHED {
  ...
  public:
    ...
    static void createSinglePaths (const stdair::NetworkDate&,
                                   const stdair::SegmentDate&);
    ...
    static void buildNetwork (const stdair::Network&,
                              const stdair::NbOfSegments_T&);

    /** Generate the i-fixed-length list of OutboundPath objects for the
        given number of segments (i). */
    static void buildNetwork (const stdair::NetworkDate&,
                              const stdair::NbOfSegments_T&);
